...
var _monet = __webpack_require__(1);

var _monet2 = _interopRequireDefault(_monet);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = _monet2.default;
module.exports.default = _monet2.default;

// Shim to make simple-monads backward compatible
_monet2.default.Either.left = _monet2.default.Either.Left;
_monet2.default.Either.right = _monet2.default.Either.Right;

_monet2.default.Either.prototype.join = function () {
    return this.cata(function (x) {
        return x;
    }, function (x) {
        return x;
    });
...
_monet2.default.Either.of = function (val) {
    return isNotNull(val) ? _monet2.default.Either.Right(val) : _monet2.default.Either.Left(val);
};
_monet2.default.Maybe.of = function (val) {
    return isNotNull(val) ? _monet2.default.Maybe.Some(val) : _monet2.default.Maybe.Nothing();
};

_monet2.default.Either.prototype.get = _monet2.default.Either.prototype.join;

_monet2.default.Either.prototype.map = function (fn) {
    return this.flatMap(function (x) {
        var result = fn(x);
        return isNotNull(result) ? _monet2.default.Either.Right(result) : _monet2.default.Either.Left(result);
    });
};

_monet2.default.Maybe.prototype.map = function (fn) {
    return this.flatMap(function (x) {
        var result = fn(x);
        return isNotNull(result) ? _monet2.default.Maybe.Some(result) : _monet2.default.Maybe.None();
    });
};

_monet2.default.Nothing = _monet2.default.None;

_monet2.default.Either.prototype.getOrElse = function (v) {
    return this.isRight() ? this.join() : v;
};

_monet2.default.Either.prototype.orElse = function (fn) {
    return this.isRight() ? this : _monet2.default.Either.of(fn(this.join()));
};

_monet2.default.Maybe.prototype.getOrElse = function (v) {
    return this.isSome() ? this.join() : v;
};

_monet2.default.Maybe.prototype.orElse = function (fn) {
    return this.isSome() ? this : _monet2.default.Maybe.of(fn(this.join()));
};
...
_monet2.default.Just.of = _monet2.default.Just;
_monet2.default.Some.of = _monet2.default.Some;
_monet2.default.None.of = _monet2.default.None;
